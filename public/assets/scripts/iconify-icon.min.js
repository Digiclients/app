...
!(function () {
    ...
    function p(t, e) {
        ...
        const i = (function (t, e) {
            ...
            return (
                (e || Object.keys(n).concat(Object.keys(i))).forEach(function t(
                    e
                ) {
                    if (n[e]) return (r[e] = []);
                    if (!(e in r)) {
    ...
    function kt(t, e) {
        ...
        return (
            (p.viewBox = b.join(" ")), { attributes: p, viewBox: b, body: c }
        );
    }
    function jt(t, e) {
        let n =
        ...
        return (
            '<svg xmlns="http://www.w3.org/2000/svg"' + n + ">" + t + "</svg>"
        );
    }
    function At(t) {
        return (
            ...
            switch (e.type) {
                case "icons": {
                    ...
                    i +=
                        t +
                        ".json?" +
                        new URLSearchParams({ icons: n }).toString();
                    break;
                }
                case "custom": {
                    const t = e.uri;
                    ...
                    switch (t) {
                        case "inline": {
                            const t = this.hasAttribute("inline"),
                                e = this._state;
                            t !== e.inline &&
                                ((e.inline = t), Rt(this._shadowRoot, t));
                            break;
                        }
                        case "noobserver":
