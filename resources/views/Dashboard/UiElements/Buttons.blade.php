...
<section class="mx-0 mx-sm-3 my-4 px-2 py-4  ">
    ...
    <h1  class="darkcolor font20 mx-2 " >Buttons</h1>
    ...
    <div class="my-2 col-md-6 mx-auto">  
        ...
        <div class="BlocksBackground dark-box-shadow rounded  p-4 mx-2">  
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <h3 class="darkcolor m-0 font18 text-capitalize"> Outline buttons </h3>
                <div>
                <button class="primarybtn minibtn d-block py-1  mx-auto copycode"> copy <span class="iconify  font20" data-icon="material-symbols:content-copy-outline"></span> </button>
            </div>
            </div>
<hr class="graycolor">
...
<div class="d-flex justify-content-between align-items-center">
        ...
        <div>
        <button class="primarybtn minibtn d-block py-1 copycode mx-auto"> copy <span class="iconify  font20" data-icon="material-symbols:content-copy-outline"></span> </button>
    </div>
    </div>
