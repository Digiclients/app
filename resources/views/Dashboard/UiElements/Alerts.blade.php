...
<section class="mx-0 mx-sm-3 my-4 px-2 py-4  ">
    ...
    <h1  class="darkcolor font20 mx-2 " >Alerts</h1>
...
<div class="d-flex justify-content-between align-items-center">
            ...
            <h3 class="darkcolor m-0 font18 text-capitalize"> Link color </h3>
            <div>
            <button class="primarybtn minibtn  py-1  mx-auto copycode"> copy <span class="iconify  font20" data-icon="material-symbols:content-copy-outline"></span> </button>
        </div>
        </div>
...
<div class="d-flex justify-content-between align-items-center">
        ...
        <h3 class="darkcolor m-0 font18 text-capitalize"> Additional content </h3>
        <div>
        <button class="primarybtn minibtn  py-1  mx-auto copycode"> copy <span class="iconify  font20" data-icon="material-symbols:content-copy-outline"></span> </button>
    </div>
    </div>
...
<div class="d-flex justify-content-between align-items-center">
        ...
        <h3 class="darkcolor m-0 font18 text-capitalize"> Icons </h3>
        <div>
        <button class="primarybtn minibtn  py-1  mx-auto copycode"> copy <span class="iconify  font20" data-icon="material-symbols:content-copy-outline"></span> </button>
    </div>
    </div>
...
<div class="d-flex justify-content-between align-items-center">
        ...
        <h3 class="darkcolor m-0 font18 text-capitalize"> Dismissing </h3>
        <div>
        <button class="primarybtn minibtn  py-1  mx-auto copycode"> copy <span class="iconify  font20" data-icon="material-symbols:content-copy-outline"></span> </button>
    </div>
    </div>
