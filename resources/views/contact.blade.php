        ...
        <form action="/contact" method="post">
          <div class="row">
                <div class="col-md-6 px-1">
                  <input name="name" type="text" class="form-control py-3 mb-2" placeholder="Votre nom" aria-label="name">
                </div>
                <div class="col-md-6 mx-auto px-1">
                  <input name="email" type="email" class="form-control py-3 mb-2" placeholder="Votre adresse e-mail">
                </div>
              </div>
              ...
              <textarea name="message" cols="40" rows="10" class=" mt-2 mb-2  form-control" aria-invalid="false" placeholder="Écrivez un message"></textarea>
        
        <br>
        
        <button class="primarybtn mt-2 mx-auto ">Envoyer le message</button>
