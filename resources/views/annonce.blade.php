    ...
    <section class="SectionsBlog py-5 container-fluid row justify-content-center">
        ...
        <div class="col-lg-12 col-xl-11 col-xxl-9 px-4 px-xl-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 mt-3 mt-lg-0 anouncePhotos pe-3">
                    ...
                    <div class="image-container">
                        ...
                        <button class="share-button d-flex align-items-center" aria-label="Ajouter l’annonce aux favoris"
                            title="Ajouter l’annonce aux favoris">
                            <iconify-icon icon="solar:share-outline" class="TheFavIcon" height="18"
                                style="width: 18px;height: 18px;"></iconify-icon>
                        </button>
                ...
                <div class="col-lg-4 mt-3 mt-lg-0  ps-3">
                    <div class="border p-3 rounded">
                        ...
                        <button type="button" class="primarybtnoutline my-2 d-block mx-auto w-100" id="d-phone"
                            data-phone="{{ $annonceDetails->annonce_phone }}">Voir le
                            numéro</button>
